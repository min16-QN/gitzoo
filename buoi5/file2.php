...
$dbh = new PDO('mysql:host=localhost;dbname=csdl', 'root', '');
...
echo "Poseidon đã được thêm thành công vào danh sách liên lạc của bạn<br>";
...
echo "ID number $id đã được cập nhật thành công<br>";
...
echo "ID number $id đã được xóa thành công<br>";
...
if ($stmt->rowCount() > 0) {
    ...
    echo "không tìm thấy hồ sơ nào.<br>";
}
